...
import com.module.testapp.presentation.exchange.adapter.CurrencyInputAdapter
import com.module.testapp.presentation.exchange.adapter.CurrencyOutputAdapter
...
class ExchangeFragment : Fragment(R.layout.fragment_exchange) {
    ...
    private fun setupViews(view: View) {
        ...
        swap = view.findViewById(R.id.iv_swap)
